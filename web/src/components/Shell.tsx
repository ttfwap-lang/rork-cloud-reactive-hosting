...
import { Activity, Bot, Crown, GitBranch, ImagePlus, Layers, Link2, LogOut, RotateCcw, ScrollText, ShieldCheck, SlidersHorizontal } from "lucide-react";
...
const NAV = [
  ...
  { to: "/batch", label: "Batch Planner", icon: Layers, end: false, ownerOnly: false },
